...
{
    public partial class WeelyHourlySale : DevExpress.XtraReports.UI.XtraReport
    {
        public WeelyHourlySale(String StoriesID, string FromDateToDate, String Title, List<WeeklyHourlySaleReport> source)
        {
            InitializeComponent();
